...
public class UsersDiffRoles_ELTC_81 {
	...
	public void loginDBTest(String firstName, String lastName,String email,String Phone,String uName,String pwd,String profile) {
		...
		screenShot.captureScreenShot("SS_UserProfile");
		UsersDiffRolesPOM.clickAddSubmit();
		UsersDiffRolesPOM.clickAdministrationTab();
		UsersDiffRolesPOM.clickAddUserstoCourse();
		UsersDiffRolesPOM.clickSelectUser1();
		UsersDiffRolesPOM.clickSelectCourseFromList();
		UsersDiffRolesPOM.clickAddtoTheCourses();
		UsersDiffRolesPOM.clickSelectUser2();
		UsersDiffRolesPOM.clickSelectCourseFromList();
		UsersDiffRolesPOM.clickAddtoTheCourses();
		UsersDiffRolesPOM.clickSelectUser3();
		UsersDiffRolesPOM.clickSelectCourseFromList();
		UsersDiffRolesPOM.clickAddtoTheCourses();
	}
